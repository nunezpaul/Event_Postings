...
eventname = "Int/Adv West Coast Swing w/ "+name+ "! (Week 1!)"
photo = '/Users/p/Desktop/Python/Facebook/Pictures/IntAdv.jpg'
day = 2+3*7 #0+7*n = Monday, 1+7*n = Tuesday, 2+7*n = Wednesday
